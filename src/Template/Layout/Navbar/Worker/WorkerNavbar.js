...
const WorkerNavbar = () => {
  ...
  return (
    <nav className="bg-white border-b border-gray-200 sticky top-0 z-50 relative">
            ...
            <div className="relative" ref={profileRef}>
              ...
              {isProfileOpen && (
                <div className="absolute right-0 mt-2 w-48 bg-white border rounded-xl shadow-lg overflow-hidden z-50">
                  <NavLink
                    to="/contractor-dashboard/contractor-profile"
      ...
      {/* Mobile Menu */}
      <div
        className={`md:hidden fixed top-20 left-0 right-0 bg-white border-t shadow-lg z-40 transition-all duration-300
